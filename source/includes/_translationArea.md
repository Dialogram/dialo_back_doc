...
```shell
curl -X POST \
  https://api.dialogram.fr/api/document/:idDocument/translation \
...
`POST https://api.dialogram.fr/api/document/:idDocument/translation`
...
```shell
curl -X PUT \
  https://api.dialogram.fr/api/document/:idDocument/translation/:idTranslation \
  -H 'Content-Type: application/json' \
  -H 'Postman-Token: ebeff399-a623-42a5-a917-0dbbcf01c189' \
  -H 'cache-control: no-cache' \
  -d '{
...
var settings = {
  "async": true,
  "crossDomain": true,
  "url": "https://api.dialogram.fr/api/document/:idDocument/translation/:idTranslation",
  "method": "PUT",
  "headers": {
    "Content-Type": "application/json",
    "cache-control": "no-cache",
...
`PUT https://api.dialogram.fr/api/document/:idDocument/translation/:idTranslation`
...
`GET https://api.dialogram.fr/api/document/:idDocument/translation/:idTranslation`
...
`DELETE https://api.dialogram.fr/api/document/:idDocument/translation/:idTranslation`
